def _all_():
    ...
    while True:
        try:
            ...
            print("")
            break
    target =  input(Fore.RED+"  ┌─["+Fore.GREEN+"H_NWWB"+Fore.BLUE+"~"+Fore.WHITE+"@WP-Hacking"+Fore.RED+"/"+Fore.CYAN+"IG"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"brout_force_wordpress"+Fore.RED+"""]
  └──╼ """+Fore.WHITE+"卐 ")
    if target == "" or None:
        time.sleep(1)
...
""".split()
        for i in my_list:
          ...
          try:
                if req == 200 or 400:
                    print(Fore.RED + "[-] The Tools")
                    print(Fore.GREEN + f"[+] ~ {new_target}  |   Found" + Fore.YELLOW + "   |   Status Code  :  " + Fore.CYAN + "200" + Fore.GREEN + " or " + Fore.CYAN + "400")
                else:
                  print(Fore.RED + f"[-] ~ {new_target}  |   Not Found" + Fore.YELLOW + "   |   Status Code  :  Not " + Fore.CYAN + "200" + Fore.GREEN + " or " + Fore.CYAN + "400")
          except:
                time.sleep(1)
                print(Fore.RED + "\n  [-] Error" + Fore.YELLOW + " >>>" + Fore.RED + " The Tools Have The Problem !")
                break
        time.sleep(1)
        print("")
